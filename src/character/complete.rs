...
use crate::stream::{split_at_offset1_complete, split_at_offset_complete, AsBStr, AsChar, Stream};
    ...
    <I as Stream>::Token: AsChar,
{
    i.next_token()
        .map(|(i, t)| (i, t.as_char()))
        .filter(|(_, t)| *t == c)
        .ok_or_else(|| ErrMode::Backtrack(Error::from_error_kind(i, ErrorKind::Char)))
}
